...
export const MyOrder = () => {
    ...
    const { currentOrder, totalPriceOrder, orders } = useSelector(state => state.orders)
    ...
    const discount = (totalPriceOrder - (totalPriceOrder * 90) / 100).toFixed(
      2
    );
  ...
  return (
    <aside className="sideMenuLayout">
      ...
      <button 
        ...
        onClick={() => onCloseOrder(orderId, purchaseDate, currentOrder, finalPrice)}
      >
        Confirm and close
      </button>
    </aside>
